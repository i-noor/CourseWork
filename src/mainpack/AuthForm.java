...
class AuthForm extends JFrame{
	/**
	 * инициализация массива для хранения названий элементов и вызов метода, генерирующего названия элементов
	 */
	private static String itemnames[] = GenerateItems.GenerateItemNames();
	/**
